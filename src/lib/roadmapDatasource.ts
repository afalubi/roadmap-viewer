...
const DEFAULT_FIELD_MAP: RoadmapFieldMap = {
  ...
  requestedDeliveryDate: 'Custom.RequestedDeliveryDate',
...
export const mapAzureDevopsItem = (
  ...
  return {
    ...
    startDate,
    endDate,
    requestedDeliveryDate: getFirstFieldValue(fields, [
      fieldMap.requestedDeliveryDate,
      'Microsoft.VSTS.Scheduling.TargetDate',
      'Custom.RequestedDeliveryDate',
    ]),
